...
<div id="primary">
    ...
    <p><?php echo __(
        "Your contribution will show up in the archive once an administrator approves it."
    ); ?>
	</p>
    <a class="button" href="<?php echo contribution_contribute_url(); ?>"><?php echo __(
    'Add another story'
); ?></a>
    <a class='button' href="<?php echo url(
        [],
        'peopleDefault'
    ); ?>"><?php echo __('View more stories'); ?></a>
