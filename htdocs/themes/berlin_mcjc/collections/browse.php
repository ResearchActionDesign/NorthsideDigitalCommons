...
<div class="collection record">
    ...
    <p class="view-items-link"><?php echo link_to_items_browse(__('View the items in %s', metadata('collection', 'display_title')), array('collection' => metadata('collection', 'id'))); ?></p>
