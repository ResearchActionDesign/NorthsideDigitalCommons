...
(slick.slider = (function () {
  ...
  return (
    ...
    (a.prototype.getAnimType = function () {
      void 0 !== document.body.style.MozTransform
        ...
        null !== this.animType && (this.transformsEnabled = !0);
    }),
    ...
    (a.prototype.startLoad = function () {
      this.options.arrows === !0 &&
        ...
        this.options.dots === !0 && this.dots.hide(),
        this.slider.addClass("slick-loading");
    }),
    (a.prototype.loadSlider = function () {
      var a = this;
      a.setPosition(),
        a.slideTrack.animate({ opacity: 1 }, this.options.speed, function () {
          a.setPosition();
        }),
    ...
    (a.prototype.setValues = function () {
    ...
    (a.prototype.buildOut = function () {
      ...
      if (
        ...
        this.options.arrows === !0 &&
          ((this.prevArrow = $('<a href="javascript:void(0)">Previous</a>')
            .appendTo(this.slider)
            .addClass("slick-prev")),
          (this.nextArrow = $('<a href="javascript:void(0)">Next</a>')
            .appendTo(this.slider)
            .addClass("slick-next")),
        ...
        for (
          ...
          $('<li><a href="javascript:void(0)">' + a + "</a></li>").appendTo(
            this.dots
          );
        if (this.options.slidesToScroll > 1) {
          this.dots.find("li").hide();
          for (var a = 0; a < this.slideCount; )
            $(this.dots.find("li").get(a)).show(),
              (a += this.options.slidesToScroll);
        }
        this.dots.find("li").first().addClass("active");
      }
      if (this.options.infinite === !0) {
        var c = null;
        for (
          a = this.slideCount;
          ...
          (c = a - 1),
            $(this.slides[c])
              ...
              .addClass("cloned");
        for (a = 0; a < this.options.slidesToShow; a++)
          (c = a),
            $(this.slides[c])
              .clone()
    ...
    (a.prototype.setDimensions = function () {
      (this.slideWidth = Math.ceil(this.listWidth / this.options.slidesToShow)),
        ...
        this.slideTrack.width(
          Math.ceil(this.slideWidth * this.slider.find(".slide").length)
        );
    }),
    (a.prototype.setPosition = function () {
      this.setValues(),
        ...
        this.options.infinite === !0 &&
          (this.slideOffset = -1 * this.slideWidth * this.options.slidesToShow);
      var a = {},
        b = -1 * this.currentSlide * this.slideWidth + this.slideOffset;
      this.transformsEnabled === !1
        ? this.slideTrack.css("left", b)
        : ((a[this.animType] = "translate(" + b + "px, 0px)"),
    ...
    (a.prototype.changeSlide = function (a) {
      switch (a.data.message) {
        ...
        case "next":
          ...
          break;
        case "index":
          this.slideHandler($(a.target).parent().index());
          break;
        default:
          return !1;
      }
    ...
    (a.prototype.slideHandler = function (a) {
      var c,
        d,
        b = {},
        e = null,
      ...
      if (
        ((c = a),
        (e = -1 * c * this.slideWidth + this.slideOffset),
        (d = -1 * this.currentSlide * this.slideWidth + this.slideOffset),
        f.options.autoplay === !0 && clearInterval(this.autoPlayTimer),
        (this.currentLeft = null === this.swipeLeft ? d : this.swipeLeft),
        0 > c)
      ) {
        if (
          (null !== this.options.onBeforeChange &&
            this.options.onBeforeChange.call(),
          this.options.infinite !== !0)
        )
          return !1;
        this.transformsEnabled === !1
          ? this.slideTrack.animate({ left: e }, f.options.speed, function () {
              (f.currentSlide = f.slideCount - f.options.slidesToScroll),
                f.setPosition(),
                f.options.dots && f.updateDots(),
                f.options.autoplay === !0 && f.autoPlay();
            })
          : $({ animStart: this.currentLeft }).animate(
              { animStart: e },
              {
                ...
                step: function (a) {
                  (b[f.animType] = "translate(" + a + "px, 0px)"),
                    f.slideTrack.css(b);
                },
                complete: function () {
                  (f.currentSlide = f.slideCount - f.options.slidesToScroll),
                    f.setPosition(),
                    null !== f.swipeLeft && (f.swipeLeft = null),
                    f.options.dots && f.updateDots(),
                    f.options.autoplay === !0 && f.autoPlay();
                },
              }
            ),
          null !== this.options.onAfterChange &&
            setTimeout(function () {
              f.options.onAfterChange.call();
            }, this.options.speed);
      } else if (c > this.slideCount - 1) {
        if (
          (null !== this.options.onBeforeChange &&
            this.options.onBeforeChange.call(),
          this.options.infinite !== !0)
                ...
                function () {
                  (f.currentSlide = c),
                    ...
                    f.options.arrows === !0 &&
                      ...
                      (0 === f.currentSlide
                        ? f.prevArrow.addClass("disabled")
                        : f.currentSlide === f.slideCount - 1
                        ? f.nextArrow.addClass("disabled")
                        : (f.prevArrow.removeClass("disabled"),
                          f.nextArrow.removeClass("disabled")));
                }
              )
            : $({ animStart: this.currentLeft }).animate(
                { animStart: e },
    ...
    (a.prototype.swipeHandler = function (a) {
      var c,
        ...
        d = null;
      switch (
        ((c = -1 * this.currentSlide * this.slideWidth + this.slideOffset),
        (this.touchObject.fingerCount = a.originalEvent.touches.length),
        (this.touchObject.minSwipe =
          this.slideWidth / this.options.touchThreshold),
        a.data.action)
      ) {
        case "start":
          1 === this.touchObject.fingerCount
            ? ((this.touchObject.startX = a.originalEvent.touches[0].pageX),
              (this.touchObject.startY = a.originalEvent.touches[0].pageY),
              (this.touchObject.curX = a.originalEvent.touches[0].pageX),
              (this.touchObject.curY = a.originalEvent.touches[0].pageY))
            : (this.touchObject = {});
          break;
        case "move":
          1 === a.originalEvent.touches.length
            ? ((this.touchObject.curX = a.originalEvent.touches[0].pageX),
              ...
              "up" !== this.swipeDirection() &&
                "down" !== this.swipeDirection() &&
                (a.originalEvent.preventDefault(),
                this.touchObject.curX > this.touchObject.startX
                  ? 1 == this.options.touchMove &&
                    ((d = c + this.touchObject.swipeLength),
                    this.transformsEnabled === !1
                      ? this.slideTrack.css("left", d)
                      : ((b[this.animType] = "translate(" + d + "px, 0px)"),
          ...
          break;
        case "end":
          if (0 === this.touchObject.fingerCount && 0 !== this.touchObject.curX)
            ...
            else this.slideHandler(this.currentSlide), (this.touchObject = {});
    ...
    (a.prototype.destroy = function () {
      this.slider.find(".cloned").remove(),
        ...
        1 == this.options.dots && this.dots.remove(),
        1 == this.options.arrows &&
          (this.prevArrow.remove(), this.nextArrow.remove()),
  ...
  ($.fn.slick = function (a) {
    ...
    return this.each(function () {
      this.slider = new slick.slider(this, a);
    });
  }),
  ($.fn.unslick = function () {
    return this.each(function () {
