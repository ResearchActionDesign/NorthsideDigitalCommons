...
if (!$pageDescription) {
    $pageDescription = "View our full list of tags here. You may prefer to <a href='/people'>browse all people</a>, <a href='/topics'>explore all topics</a>, or <a href='/search'>search for content</a>.";
}
echo head(array('title' => $pageTitle, 'bodyclass' => 'tags list'));
echo flash();
?>
<?php if (count($tags)): ?>
  ...
  <?php /* This chunk of code similar to people/index/browse.php, potentially abstract into a function */ ?>
  <div class="tags__alphabet-tabs">
    <span><?php echo __('SCROLL TO LETTER'); ?></span>
    <ul>
      <li class="active"><a href="<?php echo $this->url(array(), 'peopleDefault')?>">All</a></li>
