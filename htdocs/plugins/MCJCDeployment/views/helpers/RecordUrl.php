<?php
/**
 * Helper to return the canonical url of a record. Copies extensively from Clean_URL plugin.
 *
 ...
 */
class McjcDeployment_View_Helper_RecordUrl extends Omeka_View_Helper_RecordUrl
{
  /**
